...
dojo.declare("OfflajnImagemanager", null, {
  ...
  createFrame: function(im, folder){
    ...
    dojo.create('div', {'class': 'OfflajnWindowImgFrameImg', 'style': (im != '' ? {
      'backgroundImage': 'url("'+this.translateRelativeToAbsolute(folder+im)+'")'
    }:{}) }, frame);
    if(im != '')
  ...
  select: function(e){
    ...
    dojo.addClass(el, 'active');
    this.active = el.img;
    dojo.style(this.selectedframe.img1, 'backgroundImage', 'url("'+this.translateRelativeToAbsolute(this.folder+this.active)+'")');
  ...
  changeFrameImg: function(frame, im, folder){
    ...
    dojo.style(dojo.query(".OfflajnWindowImgFrameImg", frame)[0], {
      'backgroundImage': 'url("'+this.translateRelativeToAbsolute(folder+im+"?"+new Date().getTime())+'")'
    });
  },
  ...
  saveImage: function() {
    dojo.style(this.imgprev,'backgroundImage', 'url("'+this.translateRelativeToAbsolute(this.selectedImage)+'")');
    if(this.selectedImage != this.hidden.value) {
      this.closeWindow();
      if(this.folder == this.selectedImage) this.selectedImage = "";
      this.hidden.value = this.selectedImage;
      this.fireEvent(this.hidden, 'change');
    }
  }
...
dojo.addOnLoad(function(){
      ...
      new OfflajnList({
        name: "paramstransition",
        elements: "<div class=\"content\"><div class=\"listelement\">Sliding<\/div><div class=\"listelement\">Fading<\/div><\/div>",
        options: [{"value":"1","text":"Sliding"},{"value":"2","text":"Fading"}],
        selectedIndex: 0,
        height: 0,
        fireshow: 0
      });
      ...
      new OfflajnList({
        ...
        elements: "<div class=\"content\"><div class=\"listelement\">Disabled<\/div><div class=\"listelement\">Enabled<\/div><div class=\"listelement\">Never stop autoplay<\/div><\/div>",
        options: [{"value":"0","text":"Disabled"},{"value":"1","text":"Enabled"},{"value":"2","text":"Never stop autoplay"}],
        selectedIndex: 0,
        height: 0,
        fireshow: 0
      });
...
dojo.addOnLoad(function(){ 
      ...
      new OfflajnCombine({
        ...
        new OfflajnImagemanager({
          id: "paramsshadow",
          folder: "/modules/mod_smartslider/images/shadows/",
          root: "http://localhost/thepdahoi.vn/wp-content/plugins/nextend-smart-slider-lite/joomla/",
          uploadurl: "admin.php?page=smartslider.php/slider&option=offlajnupload",
          imgs: ["Curved-Dark.png","Curved-Light.png","Curved-Smooth.png","Float.png","Simple.png"],
          active: "",
          identifier: "1b16b48a1c27c841cfd7ed9a5c4c20cc",
          description: "",
          siteurl: "http://localhost/thepdahoi.vn/wp-admin/"
        });
